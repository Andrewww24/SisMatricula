  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 text-center">
        ...
        <h1 className="text-2xl font-bold text-slate-800 mb-2">Reportes del sistema</h1>
        <p className="text-slate-500">Este módulo estará disponible próximamente (RF-20, RF-21).</p>
      </div>
    </main>
  );
}
